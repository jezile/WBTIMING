        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="https://jezile.typeform.com/to/xbh7bc" target="_blank"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Zapisz się teraz!</a></li>
                    <li>@IconActionLink(Html, "fa fa-users", "Zarejestrowani", "Athlete", "WBXC", New With {.event = "1000"}, Nothing)</li>
                </ul>
            </div>
        </div>
    </div>
